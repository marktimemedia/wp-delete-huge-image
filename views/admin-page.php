<div class="wrap">
    ...
    <?php if ( count( get_settings_errors()) > 0 ) : ?>
        ...
        <div class="error">
            <?php foreach( get_settings_errors() as $errorArr ) :
    ...
    <form method="post" action="options.php" enctype="multipart/form-data">
        ...
        <?php settings_fields( 'doi_options_group' ); //what does this shit do? ?>
        <?php submit_button(); ?>
    </form>
    ...
    <script type="text/javascript" >
        jQuery("form#delete-all-originals").on('submit', function(e) {
            if (confirm("This option will delete all your original uploaded images and can't be undo, but it will not break anything. Continue?")) {
